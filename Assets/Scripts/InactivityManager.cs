...
public class InactivityManager : MonoBehaviour
{
    ...
    void ShowPanel()
    {
        ...
        Time.timeScale = 0f;
        WebDataLogger.Instance.LogScreenEvent("inactivity_warning", "onset");
    }

    public void OnContinueButton()
    {
        WebDataLogger.Instance.LogScreenEvent("inactivity_warning", "offset");
        panelVisible = false;
        lastInputTime = Time.unscaledTime;
        inactivityPanel.SetActive(false);
    ...
    {
        WebDataLogger.Instance.LogScreenEvent("inactivity_timeout", "onset");
        WebDataLogger.Instance.TriggerInactivityTimeout();
